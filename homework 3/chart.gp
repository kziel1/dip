...
set xlabel "kernel size in pixels"
set ylabel "image size in pixels"
set zlabel "time in s"
set output "chart_frequency.png"
splot "data_points_frequency.csv"
set output "chart_spatial.png"
splot "data_points_spatial.csv"